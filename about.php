 ...
 <div class="clear"></div>
		...
		<div id="main" class="shell">
			...
			<div id="content">
				<div class="post">
					<h2>Welcome!</h2>
					<img src="images/logo.png" alt="Post Image" height="160" width="260"/>Welcome to Nicholasian E-commerce, your hub for research-driven online shopping! Explore our curated selection of products while delving into insightful research articles and reviews to make informed purchasing decisions. Please note that the products on our website are for testing purposes only and are not available for actual sale. Shop smart with Nicholasian E-commerce.
